...
clusterExport(cl, c("dat", "dat_subset","single_grid","alpha","end_row","n_chains","n_cols","n_rows","num_cores","reps","start_row", "maximinLHD_geom"))
clusterEvalQ(cl, {
  library(here)
  library(Rcpp)
  sourceCpp(here("maximin_geom_seq.cpp"))
...
saveRDS(final_dat, file = here::here("sim_results1.rds")) ## precious data

final_dat <- readRDS(here::here("sim_results1.rds"))
